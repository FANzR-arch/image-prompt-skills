...
- `H1 sparse flat object`: matches, cigarettes, pencils, keys, switches, earbuds, simple tools. Few shapes, strong negative space, flat silhouette.
- `H2 semi-rendered glass/metal`: bulbs, bottles, watches, lenses, chrome, polished objects. Hand-painted highlights and simplified realism.
- `H3 package/label hero`: soap, coffee, shoe polish, tea, medicine, perfume box, wrappers. Package label participates.
- `H4 cropped product macro`: boots, bags, tools, cameras, keyboards, phones. Product fills the frame and may be cropped.
...
- Earbuds, keys, switches, small gadgets -> H1 + T2 or T4 + L1/L2 + B1/B2 + C3/C4.
- Glass bulb, bottle, camera lens, smartwatch face -> H2 + T2 + L2/L3/L8 + B3 + C2/C4.
- Soap, coffee bag, shoe polish tin, wrapper, label -> H3 + T3/T5 + L5 + B4 + C3/C6.
- Shoe, boot, keyboard, tools, power bank -> H4/H5 + T1/T4 + L4/L7 + B1/B2 + C3/C4.
