...
> 注：gpt-image-2 支持任意尺寸，只要同时满足长边 <3840、双边 16 的倍数、比例 ≤3:1、总像素 655,360–8,294,400。四种画幅都是原生的，不需要裁切。合法值：4:5 → `1664×2080`，16:9 → `2560×1440`，1:1 → `2048×2048`，5:2 → `3200×1280`。
